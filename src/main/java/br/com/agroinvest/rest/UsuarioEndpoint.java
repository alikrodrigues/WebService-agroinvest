package br.com.agroinvest.rest;
...
import br.com.agroinvest.model.Usuario;
...
public class UsuarioEndpoint {
	...
	public Response login(@PathParam("usuario") String login,@PathParam("senha") String senha) {
		TypedQuery<Usuario> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT u FROM Usuario u WHERE u.login = :usuario AND u.senha = :senha ORDER BY u.id",
						Usuario.class);
		findByIdQuery.setParameter("usuario", login);
